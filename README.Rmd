...
The Patterns package is a complete 
...
![Evolution of a reverse-engineered network with increasing cut-off values (mp4).](docs/reference/evolution/animation.mp4){width=400 height=300}

Evolution of a reverse-engineered network with increasing cut-off values (mp4).

<video width="400" height="320" controls>
  <source src="docs/reference/evolution/animation.mp4" type="video/mp4">
</video>
